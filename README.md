...
Everything in this repository is licensed under [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0)](./LICENSE).

You are free to:
- **Read, share, and remix** the content
- **Translate** the Bible into other languages
- **Fork** the repository to create your own version
- **Use the content** in personal projects, blogs, education, and non-commercial works

Provided that you:
- **Give credit** to the Bible and original contributors
- **Don't use it for commercial purposes** (without separate written permission)
...
### To Read
Just browse the [`chapters/`](./chapters) directory. Every recipe is a standalone Markdown file with a structured YAML header.

### To Contribute

1. **Read** the [CONTRIBUTING.md](./CONTRIBUTING.md) guide
2. **Pick a path**:
   - **5-minute**: Submit a [Verified Brew](./CONTRIBUTING.md#verified-brews) — confirm you brewed an existing recipe and add your feedback
   - **30-minute**: Submit a [correction or improvement](./CONTRIBUTING.md#corrections) to an existing recipe
   - **A few hours**: Translate a recipe into another language
   - **A few weeks**: Write a brand-new recipe chapter using the [TEMPLATE.md](./TEMPLATE.md)
3. **Open a Pull Request** — by doing so, you accept the [CLA](./CLA.md)
4. **Get reviewed** by the community and maintainer team
5. **Earn your place** in the project — and, for substantial contributors, in the printed edition
...
|------|-----------|----------|
| **Apprentice** | 1 merged contribution, or 5 Verified Brews | Repo credit, digital badge, BrewPoints |
| **Brewer** | 3 merged contributions + 10 Verified Brews | Above + iGulu ingredient pack discount, newsletter credit |
| **Master Brewer** | 10 merged + 1 recipe verified by 10+ brewers | Above + iGulu device, editorial vote, printed edition credit |
| **Saint / Honorary Member** | Invited; first 50 Founding Contributors qualify | Above + lifetime benefits, printed edition royalty share, project governance vote |
...
- **GitHub Issues** — bug reports, recipe requests, content questions
- **Discord** — real-time discussion, brew-along events, contributor coordination *(invite link coming at public launch)*
- **Newsletter — Weekly Ferment** — weekly digest of new recipes, science snippets, and community highlights *(subscribe at launch)*
